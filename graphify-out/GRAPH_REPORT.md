...
10. `getSupabaseClient()` - 9 edges

## Surprising Connections (you probably didn't know these)
- `detectBridges()` --calls--> `POST()`  [INFERRED]
  lib/tracer.ts → app/api/trace/route.ts
- `detectDeepMixers()` --calls--> `POST()`  [INFERRED]
  lib/tracer.ts → app/api/trace/route.ts
...
Cohesion: 0.16
Nodes (17): fetchAddresses(), main(), extractAddresses(), main(), scanXmlNode(), main(), fetchAndParseXml(), main() (+9 more)
